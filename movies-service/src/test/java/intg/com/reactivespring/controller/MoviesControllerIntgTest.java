...
public class MoviesControllerIntgTest {
    ...
    void getMovieById() {
        ...
        webTestClient.get()
                ...
                .consumeWith(movieEntityExchangeResult -> {
                    ...
                    assertEquals("Batman 1", movie.getMovieInfo().getName());
                });
    }
    ...
    @Test
    void getMovieById_reviews_notFound() {
        var movieId ="abc";
        stubFor(get(urlEqualTo("/v1/moviesinfo"+"/"+movieId))
                .willReturn(aResponse()
                        .withHeader("Content-Type","application/json")
    ...
    void getMovieById_serverError() {
        ...
        webTestClient.get()
                ...
                .is5xxServerError()
                .expectBody(String.class)
                .isEqualTo("Server exception in MoviesInfoService, Service Unavailable");

        //verifying the retry behaviour
        WireMock.verify(4,getRequestedFor(urlEqualTo("/v1/moviesinfo"+"/"+movieId)));
    }

    @Test
    void getReviewsById_serverError() {
        var movieId ="abc";
        stubFor(get(urlEqualTo("/v1/moviesinfo"+"/"+movieId))
                .willReturn(aResponse()
                        .withHeader("Content-Type","application/json")
        ...
        webTestClient.get()
                ...
                .is5xxServerError()
                .expectBody(String.class)
                .isEqualTo("Server exception in ReviewService, Service Unavailable");
